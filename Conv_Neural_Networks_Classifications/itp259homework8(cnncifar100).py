# -*- coding: utf-8 -*-
"""ITP259Homework8(CNNCifar100).ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/19ewuTwpyv9-yXu40pv6pwewGDep7ds5G
"""
...
"""1. Write code to train a CNN model which classifies the CIFAR100 dataset. Load the dataset directly from keras.
a. There are coarse and fine labels.
b. Load only the fine labeled dataset.
c. Image are 32x32 pixels.
d. Three color channels.

2. Parition the dataset into train and test sets. Print the shapes of the train and test data sets.
"""
...
"""5. Build a CNN sequence of layers. Must contain the following layers.
